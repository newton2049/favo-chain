...
## Your environment
- OS and version.
- The version of the Favo Edge.    
  (*Confirm the version of your Favo edge client by running the following command: `favo-chain version --grpc-address GRPC_ADDRESS`*)
...
- Provide us with the peer list of each of your validators by running the following command: `favo-chain peers list --grpc-address GRPC_ADDRESS`.
