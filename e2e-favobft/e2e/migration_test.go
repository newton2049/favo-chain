...
import (
	...
	frameworkfavobft "github.com/newton2049/favo-chain/e2e-favobft/framework"
...
func TestMigration(t *testing.T) {
	...
	err = frameworkfavobft.RunEdgeCommand([]string{
		"regenesis",
	...
	cluster := frameworkfavobft.NewTestCluster(t, 7,
		frameworkfavobft.WithNonValidators(2),
		frameworkfavobft.WithValidatorSnapshot(5),
		frameworkfavobft.WithGenesisState(tmpDir, types.Hash(stateRoot)),
	)
	defer cluster.Stop()
