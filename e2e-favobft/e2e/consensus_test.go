...
func TestE2E_Consensus_RegisterValidator(t *testing.T) {
	...
	systemState := favobft.NewSystemState(
	...
	extra, err := favobft.GetIbftExtra(genesisBlock.ExtraData)
	require.NoError(t, err)
...
func TestE2E_Consensus_Validator_Unstake(t *testing.T) {
	...
	rootchainValidators := []*favobft.ValidatorInfo{}
