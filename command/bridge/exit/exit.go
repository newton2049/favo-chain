...
import (
	...
	"github.com/newton2049/favo-chain/command/bridge/common"
	cmdHelper "github.com/newton2049/favo-chain/command/helper"
...
func createExitTxn(sender ethgo.Address, proof types.Proof) (*ethgo.Transaction, *favobft.ExitEvent, error) {
	...
	var exitEvent *favobft.ExitEvent
