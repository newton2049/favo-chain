...
import (
	...
	"github.com/newton2049/favo-chain/secrets/helper"
...
func ReadValidatorsByPrefix(dir, prefix string) ([]*favobft.Validator, error) {
	validatorKeyFiles, err := GetValidatorKeyFiles(dir, prefix)
	if err != nil {
		return nil, err
	}

	validators := make([]*favobft.Validator, len(validatorKeyFiles))
