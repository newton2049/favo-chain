...
This command funds the initialized accounts via `favo-chain favobft-secrets` command.

```bash
$ favo-chain rootchain fund --data-dir data-dir- --num 2
```
Or
```bash
$ favo-chain rootchain fund --data-dir data-dir-1
```
