...
var _ favobftBackend = (*favobftBackendMock)(nil)

type favobftBackendMock struct {
	mock.Mock
}

// GetValidators retrieves validator set for the given block
func (p *favobftBackendMock) GetValidators(blockNumber uint64, parents []*types.Header) (AccountSet, error) {
	...
	panic("favobftBackendMock.GetValidators doesn't support such combination of arguments") //nolint:gocritic
}
